...
from off_campus_housing_app import views, HodViews, StaffViews, StudentViews
from off_campus_housing_app.EditResultVIewClass import EditResultViewClass
...
urlpatterns = [
    ...
    path('restrict_student_user', HodViews.restrict_student_user,
         name="restrict_student_user"),
    path('restrict_landlord_user', HodViews.restrict_landlord_user,
         name="restrict_landlord_user"),
    ...
    path('old_messages/', HodViews.old_messages, name="old_messages"),
    path('unread_messages/', HodViews.unread_messages, name="unread_messages"),
    ...
    path('join_class_room/<int:subject_id>/<int:session_year_id>',
